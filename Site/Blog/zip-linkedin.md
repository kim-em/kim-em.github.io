...
That theorem explain how we can make lean-zip so fast. We turned AI agents (Claude and Codex) loose on the optimisation problem,
insisting that the theorem above stays true. The theorem lets us move quickly, and confidently, as the AIs explore agressive optimisations.
